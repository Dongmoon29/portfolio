...
export const OsxWindowHeader: FC<OsxWindowHeaderProps> = ({
  ...
  return (
    <div
      className={`grid grid-cols-3 justify-center items-center text-white bg-gray-700  p-2 h-10`}
    >
      <div className="flex justify-start gap-2">
        ...
        <div
          ...
          className="rounded-full bg-green-300 w-4 h-4 flex justify-center items-center p-2"
        ></div>
      </div>
